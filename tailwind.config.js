...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'gradient-magenta': 'linear-gradient(135deg, #8b5cf6 0%, #d946ef 50%, #ec4899 100%)',
      ...
      boxShadow: {
        ...
        glow: '0 10px 40px rgba(139, 92, 246, 0.4), 0 0 20px rgba(217, 70, 239, 0.2)',
        'glow-cyan': '0 10px 40px rgba(6, 182, 212, 0.4)',
        'glow-pink': '0 10px 40px rgba(217, 70, 239, 0.4)',
        'glow-sm': '0 4px 20px rgba(139, 92, 246, 0.3)',
      ...
      keyframes: {
        ...
        pulseGlow: {
          ...
          '50%': { boxShadow: '0 0 50px rgba(139, 92, 246, 0.6), 0 0 80px rgba(217, 70, 239, 0.3)' },
        },
        float: {
